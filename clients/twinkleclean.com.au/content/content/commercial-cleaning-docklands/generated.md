...
Every tenancy is quoted on its own numbers: floor area, desk count, number of meeting rooms and amenities, frequency, and what the building allows in terms of after-hours access. Publishing a flat rate would be guesswork, so we price each site individually and the quote costs nothing. Regular schedules and one-off cleans are both available, and everything runs without lock-in contracts.
