...
## Identity
- **Domain:** energus.com.au
- **Business name:** Energus Pty Ltd
- **ABN:** 81 168 985 288
- **Founded:** 2014
- **Phone:** 1300 090 187
- **Address:** Level 9, 153 Walker Street, North Sydney, NSW 2060
- **Email:** sales@energus.com
- **Hours:** 9am–5pm Mon–Fri
- **Website:** https://energus.com.au

## Business Type
**Nationwide B2B — Commercial & Industrial solar and battery storage**
- NOT residential. No residential solar keywords ever.
- Operates across NSW, QLD, VIC, SA
- Headquartered in North Sydney

## Core Services
| Service | Notes |
|---------|-------|
| Commercial solar installation | New constructions + retrofit |
| Industrial solar installation | C&I focus |
| Battery Energy Storage Systems (BESS) | Also called C&I battery / commercial battery |
| Solar system design & engineering | In-house engineers |
| Solar project management | Site-experienced PMs |
| Solar for businesses | Business owner / CFO audience |
| Solar for property groups | Property developers |
| Lightweight solar (eARC) | Sunman eARC technology — unique differentiator |
| Solar finance | Finance options available |
| Solar monitoring | Ongoing service |
| Solar servicing | Maintenance |
| Energy consulting | Advisory |
| Procurement & logistics | End-to-end capability |

## Target Customers
1. Construction companies / major builders — solar during new build
2. Property developers / property groups
3. Business owners and CFOs — retrofit commercial solar
4. Large corporates
...
2. In-house solar & battery engineers
