title: Retractable Roof System Melbourne | Delta Pro | Skyflex
meta_description: A motorised, 100% waterproof retractable roof system for Melbourne. Open it in the sun, close it in the rain. Supplied by Skyflex, ready to order online.
...
The roof panel is a durable PVC fabric that resists mildew and holds its finish season after season with almost no upkeep. Closed, it seals to 100% waterproof and blocks direct sun, which keeps the space beneath it noticeably cooler through summer. The drive motor is a Dooya unit rated to IP67, so it is sealed against dust and water where it sits out in the weather rather than tucked indoors. Integrated LED lighting runs along the frame, which means the area stays usable after dark without wiring in a separate light. Together those parts answer the two things that stop most people using an outdoor room: harsh sun in January and a downpour in April.

## Delta Pro specifications

- Roof type: motorised retractable PVC fabric roof on an aluminium track
- Sizes, free-standing unit: 3x3, 3x4, 3x5, 4x4, 4x5 and 6x4 metres
- Fabric colours: Beige, Black or White
- Frame colours: Black, Charcoal or White
- Motor: Dooya, 40W, DC 24V, sealed to IP67, standard AU plug-in
- Operation: handheld remote to open, close or stop at any point
...
Choose your size, fabric and frame colour and add the Delta Pro to your cart, or call the Skyflex team in Melbourne on 03 9498 0505 to talk through the right size for your space before you buy.
