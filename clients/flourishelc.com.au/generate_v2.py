...
add_page(
    ...
    "Our purpose-built centre near Riverstone meets and exceeds the National Quality Framework (NQF). That means every aspect of the physical environment, our educator qualifications, our program quality, and our family partnerships has been thoughtfully considered and regularly assessed against Australia's highest national standards for early education.\n\nOur educators are qualified, warm, and genuinely committed to each child they care for. They take the time to know every child as an individual: what makes them curious, what makes them feel safe, and what they are ready to explore next. That personal attention makes a real difference to children and families alike.\n\nWe are open Monday to Friday, 7:00am to 6:00pm. Our parent communication app delivers real-time updates and photos throughout the day so families near Riverstone always feel connected to what their child is experiencing, no matter how busy life gets.",
    "Frequently Asked Questions",
    [
        ("What ages do you cater for near Riverstone?", "From 6 weeks through to school age, with dedicated programs and spaces for infants, toddlers, and preschoolers at every stage of development."),
        ("What meals are included?", "Five nutritious meals daily: breakfast, morning tea, lunch, afternoon tea, and a late snack. Dietary requirements and allergies are always catered for with care."),
        ("What are your opening hours?", "Monday to Friday, 7:00am to 6:00pm, giving families a generous window for drop-off and pick-up."),
        ...
        ("How does Flourish ELC approach school readiness?", "School readiness is woven through our programs from an early age, building literacy, numeracy, independence, and social skills so children transition to kindergarten feeling genuinely ready and excited."),
    ]
)
...
add_page(
    ...
    "Our purpose-built centre near Rossmoyne meets and exceeds the National Quality Framework (NQF). Every aspect of the centre has been assessed against Australia's national quality standards, from the learning environments and educator qualifications to the family partnerships and leadership practices. We are proud of that standard and work hard every day to uphold and exceed it.\n\nOur educators are qualified, caring professionals who take the time to genuinely know each child. They observe, listen, and respond to what children need, creating a day-to-day experience that is both nurturing and stimulating. That kind of attention is what makes Flourish ELC feel different from the moment families walk through the door.\n\nWe are open Monday to Friday, 7:00am to 6:00pm. Our parent communication app keeps families near Rossmoyne connected throughout the day with real-time updates, photos, and notes from our educators, so no milestone goes unshared.",
    "Frequently Asked Questions",
    [
        ("What ages do you cater for near Rossmoyne?", "We welcome children from 6 weeks to school age, with dedicated programs and spaces for infants, toddlers, and preschoolers."),
        ("What meals are included daily?", "Five nutritious meals prepared fresh every weekday: breakfast, morning tea, lunch, afternoon tea, and a late snack. All dietary requirements and allergies are carefully managed."),
        ("What are the opening hours?", "Monday to Friday, 7:00am to 6:00pm, designed to support busy working families."),
        ("How does the parent app keep me connected?", "The app delivers real-time updates, photos, and observations throughout the day so you always have a clear, warm window into your child's world."),
        ("How does school readiness work at Flourish ELC?", "We build literacy, numeracy, social and emotional skills, and independence progressively through our programs so children transition to kindergarten genuinely ready, confident, and excited for what comes next."),
    ]
)
